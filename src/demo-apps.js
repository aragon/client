const rawApps = [
  ...
  },
  {
    ...
    abi: [
      ...
      },
      {
        ...
        type: 'event',
        signature:
          '0x33c2d6285ba1442f7dd954820743aacec7468bc52e1671024b948f48f1322640',
      },
      {
        anonymous: false,
        inputs: [
      ...
      },
      {
        ...
        type: 'event',
        signature:
          '0x28bb663e324957c72fa46db87d8afa7591b1c293b2c7ad06e3574eace993ff6d',
      },
    ],
    functions: [
      {
        ...
        roles: [],
        notice:
          "Initializes Voting app with `_token.symbol(): string` for governance, minimum support of `(_supportRequiredPct - _supportRequiredPct % 10^14) / 10^16`, minimum acceptance quorum of `(_minAcceptQuorumPct - _minAcceptQuorumPct % 10^14) / 10^16` and vote duations of `(_voteTime - _voteTime % 86400) / 86400` day `_voteTime >= 172800 ? 's' : ''`",
      },
      {
        sig: 'changeMinAcceptQuorumPct(address)',
        roles: ['MODIFY_QUORUM_ROLE'],
        notice:
          'Change minimum acceptance quorum to `(_minAcceptQuorumPct - _minAcceptQuorumPct % 10^14) / 10^16`%',
      },
      {
    ...
    roles: [
      {
        ...
        params: ['Token address', 'Token amount'],
        bytes:
          '0xb3f7dd79e11d8e7e7ea82a3f0424d577d6c904b62e54a58458d29b327336decd',
      },
      {
  ...
  },
  {
    ...
    name: 'Token Manager',
    description:
      'Controls an organization token allowing to mint new tokens, assign them and create vestings',
    icons: [
      {
        src: 'images/icon.png',
        sizes: '192x192',
    ...
    abi: [
      ...
      },
      {
        ...
        type: 'event',
        signature:
          '0x627ad26dcfe82ec79b33fda0ddd062f6fab9f4914acac8345f79090dfd86fb54',
      },
      {
        anonymous: false,
        inputs: [
        ...
        type: 'event',
        signature:
          '0xd84a4ab319cd8ac27a1baf06f5020baf3eb7692cca480d7a7fb68596befe5ca9',
      },
    ],
    functions: [
      {
        ...
        roles: [],
        notice:
          "Initializes Token Manager for `_token.symbol(): string`, `transerable ? 'T' : 'Not t'`ransferable`_maxAccountTokens > 0 ? ', with a maximum of ' _maxAccountTokens ' per account' : ''` and with`_logHolders ? '' : 'out'` storage of token holders.",
      },
      {
      ...
      },
      {
        ...
        roles: ['ASSIGN_ROLE'],
        notice:
          "Assign `_amount / 10^18` tokens to `_receiver` from Token Manager's holdings",
      },
      {
      ...
      },
      {
        ...
        roles: ['ASSIGN_ROLE'],
        notice:
          "Assign `_amount / 10^18` tokens to `_receiver` with a `_revokable : 'revokable' : ''` vesting starting at `_start` and a cliff at `_cliff`, with vesting on `_vesting`",
      },
      {
        sig: 'revokeVesting(address,uint256)',
        roles: ['REVOKE_VESTINGS_ROLE'],
        notice:
          'Revoke vesting `_vestingId` from `_holder`, returning unvested tokens to Token Manager',
      },
      {
        sig: 'forward(bytes)',
        roles: [],
